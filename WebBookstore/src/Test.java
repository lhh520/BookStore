...
//管理员删除
	...
	public Test(String ming1)
	{
		...
		setBounds(((Toolkit.getDefaultToolkit().getScreenSize().width)/2)-300, ((Toolkit.getDefaultToolkit().getScreenSize().height)/2)-300,800,800);
		//JMenuBar menuBar = new JMenuBar();// 创建菜单栏对象
